...
## NEEDS PARENTAL AGE (avg > mom > parent > na) in '88
echo$rental_age_1988 <- )
...
echo$degree_1992 <- ifelse(echo$degree_1992 == 1, 1,
                    ...
                    ifelse(echo$degree_1992 >= 5, 4,
                       0))))
table(echo$degree_1992)
echo$degree_1992 <- ifelse(echo$degree_1992 > echo$degree_1990, echo$degree_1992,
                           echo$degree_1990)
table(echo$degree_1992)
...
echo$degree_2004 <- ifelse(echo$degree_2004 == 1, 1,
                    ...
                    ifelse(echo$degree_2004 >= 5, 4,
                      0))))
table(echo$degree_2004)
echo$degree_2004 <- ifelse(echo$degree_2004 > echo$degree_2000, echo$degree_2004,
                           echo$degree_2000)
table(echo$degree_2004)
...
echo$degree_2008 <- ifelse(echo$degree_2008 == 1, 1,
                    ...
                    ifelse(echo$degree_2008 >= 5, 4,
                      0))))
table(echo$degree_2008)
echo$degree_2008 <- ifelse(echo$degree_2008 > echo$degree_2004, echo$degree_2008,
                           echo$degree_2004)
table(echo$degree_2008)
...
echo$degree_2012 <- ifelse(echo$degree_2012 == 1, 1,
                    ...
                    ifelse(echo$degree_2012 >= 5, 4,
                      0))))
table(echo$degree_2012)
echo$degree_2012 <- ifelse(echo$degree_2012 > echo$degree_2008, echo$degree_2012,
                           echo$degree_2008)
table(echo$degree_2012)
