...
colnames(categories)  <- c(
  ...
  "networth_1988", "employ_1988", "w1_1988", "w2_1988", "totinc_1988", 
  "region_1988", "marstat_1988", "reside_1988", "kidnum_1988",
  ## 1989
  "degree_1989", "hours_1989", "gift_1989", "value_1989", "networth_1989",  
  "employ_1989", "w1_1989", "w2_1989", "totinc_1989", "region_1989", 
  "marstat_1989", "reside_1989", "kidnum_1989",
  ## 1990
  "degree_1990", "hours_1990", "gift_1990", "value_1990", "networth_1990", 
  "employ_1990", "w1_1990", "w2_1990", "totinc_1990", "region_1990", 
  "marstat_1990", "reside_1990", "kidnum_1990",
  ## 1991
  "degree_1991", "gift_1991", "value_1991", 
  ## 1992
  "degree_1992", "hours_1992", "gift_1992", "value_1992", "networth_1992", 
  "employ_1992", "w1_1992", "w2_1992", "totinc_1992", "region_1992", 
  "marstat_1992", "reside_1992", "kidnum_1992",
  ## 1993
  "degree_1993", "hours_1993", "employ_1993", "gift_1993", "value_1993",
  "networth_1993", "w1_1993", "w2_1993", "totinc_1993", "region_1993", 
  "marstat_1993", "reside_1993", "kidnum_1993",
  ## 1994
  "degree_1994", "hours_1994", "employ_1994", "gift_1994", "value_1994", 
  "networth_1994", "w1_1994", "w2_1994", "totinc_1994", "region_1994", 
  "marstat_1994", "reside_1994", "kidnum_1994",
  ## 1996
  "w1_1996", "w2_1996", "totinc_1996", "region_1996", "marstat_1996", 
  "reside_1996", "kidnum_1996", "degree_1996", "hours_1996", "employ_1996", 
  "gift_1996", "value_1996", "networth_1996",
  ## 1998
  "degree_1998", "hours_1998", "gift_1998", "value_1998", "networth_1998",
   "w1_1998", "w2_1998", "employ_1998", "totinc_1998", "region_1998", 
  "marstat_1998", "reside_1998", "kidnum_1998",
  ## 2000
  "degree_2000", "hours_2000", "employ_2000", "networth_2000", "gift_2000",
  "value_2000", "w1_2000", "w2_2000", "totinc_2000", "region_2000", 
  "marstat_2000", "reside_2000", "kidnum_2000",
  ## 2002
  "degree_2002", "gift_2002", "value_2002", 
  ## 2004
  "degree_2004", "hours_2004", "employ_2004", "gift_2004", "value_2004",
  "networth_2004", "w1_2004", "w2_2004", "totinc_2004", "region_2004", 
  "marstat_2004", "reside_2004", "kidnum_2004",
  ## 2006
  "degree_2006", "gift_2006", "value_2006", 
  ## 2008
  "degree_2008", "hours_2008", "employ_2008", "gift_2008", "value_2008", 
  "networth_2008", "w1_2008", "w2_2008", "totinc_2008", "region_2008", 
  "marstat_2008", "reside_2008", "kidnum_2008",
  ## 2010
  "degree_2010", "gift_2010", "value_2010",
  ## 2012
  "degree_2012", "hours_2012", "employ_2012", "gift_2012", "value_2012",
  "networth_2012", "w1_2012", "w2_2012", "totinc_2012", "region_2012", 
  "marstat_2012", "reside_2012", "kidnum_2012"
)
...
# 1980
# table(echo$employ_1980)
# sum(is.na(echo$employ_1980))
# echo$employ_1980 <- ifelse(echo$employ_1980 == 3, 1,0)
# echo$employ_1980 <- ifelse(is.na(echo$employ_1980), 0, echo$employ_1980)
# sum(is.na(echo$employ_1980))
# table(echo$employ_1980)
# 1981
# table(echo$employ_1981)
# echo$employ_1981 <- ifelse(echo$employ_1981 == 3, 1, 0)
# echo$employ_1981 <- ifelse(is.na(echo$employ_1981), 0, echo$employ_1981)
# sum(is.na(echo$employ_1981))
# table(echo$employ_1981)
# echo$employ_1981 <- ifelse(echo$employ_1981 == 1, 1, 
#                     ifelse(echo$employ_1981 == 0 & echo$employ_1980 == 1, 0)     
# table(echo$employ_1981)
# 1982                    
# 1983 
# 1984 
...
echo$hours_1988 <- ifelse(echo$hours_1988 >= 35, 1, 0)
echo$hours_1989 <- ifelse(echo$hours_1989 >= 35, 1, 0)
echo$hours_1990 <- ifelse(echo$hours_1990 >= 35, 1, 0)
echo$hours_1992 <- ifelse(echo$hours_1992 >= 35, 1, 0)
echo$hours_1993 <- ifelse(echo$hours_1993 >= 35, 1, 0)
echo$hours_1994 <- ifelse(echo$hours_1994 >= 35, 1, 0)
echo$hours_1996 <- ifelse(echo$hours_1996 >= 35, 1, 0)
echo$hours_1998 <- ifelse(echo$hours_1998 >= 35, 1, 0)
echo$hours_2000 <- ifelse(echo$hours_2000 >= 35, 1, 0)
echo$hours_2004 <- ifelse(echo$hours_2004 >= 35, 1, 0)
echo$hours_2008 <- ifelse(echo$hours_2008 >= 35, 1, 0)
echo$hours_2012 <- ifelse(echo$hours_2012 >= 35, 1, 0)
